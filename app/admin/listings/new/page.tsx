                ...
                <>
                  <fieldset className="mt-4 space-y-2">
                    ...
                    <label className="flex cursor-pointer items-center gap-2 text-sm">
                      <input
                        type="radio"
                        name="cap-rate-mode-new-for-sale"
                        checked={!form.capRatePricingCall}
                        onChange={() => setForm((f) => ({ ...f, capRatePricingCall: false }))}
                      />
                      Enter NOI &amp; cap rate
                    </label>
                    <label className="flex cursor-pointer items-center gap-2 text-sm">
                      <input
                        ...
                        name="cap-rate-mode-new-for-sale"
                        checked={form.capRatePricingCall}
                        onChange={() => setForm((f) => ({ ...f, capRatePricingCall: true, noi: "", capRate: "" }))}
                      />
                  ...
                  <>
                    <fieldset className="mt-3 space-y-2">
                      ...
                      <label className="flex cursor-pointer items-center gap-2 text-sm">
                        <input
                          type="radio"
                          name="cap-rate-mode-new-sale-lease"
                          checked={!form.capRatePricingCall}
                          onChange={() => setForm((f) => ({ ...f, capRatePricingCall: false }))}
                        />
                        Enter NOI &amp; cap rate
